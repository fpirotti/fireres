...
*/
    ...
    if(uid in validUsers){
        updateLogger("Welcome "+validUsers[uid]+", your validated unique id is: <a href='mailto:fpirotti@gmail.com?subject=geocatchappid-"+uid+"'>" + uid+"</a>. You can view your photoes <a href='incoming/index.html' target='_blank'>HERE</a>", 'logger', newline = false);
    } else {
        updateLoggerAlert("Welcome, your unique id is "+ uid +" <b>please validate</b> your app<br> " +
            " by sending an email: just click the link below to open your email provider: <br> <a href='mailto:fpirotti@gmail.com?subject=geocatchappid-"+uid+"'>==>  VALIDATE<==</a>", 3, 1,500000);
    }
...
// event listener when going offline
    ...
    navigator.permissions.query({name:'geolocation'}).then((result) => {
        ...
        result.onchange = () => {
            updateLoggerAlert(`geolocation permission status has changed to ${result.state}`, 2,1);
